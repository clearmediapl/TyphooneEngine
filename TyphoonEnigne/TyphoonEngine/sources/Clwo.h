...
public:
	...
	void            CreateCollisionTree(NewtonWorld *nWorld, NewtonTreeCollisionCallback levelCallbac, CVector startPos);
	void			CreateCollisionBBOX(NewtonWorld *nWorld, CVector startPos, CVector rotation);
